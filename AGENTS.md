...
- Do not launch, relaunch, or spawn additional GMod instances unless the user explicitly asks for runtime verification.
    - If GMod is already running, do not start another copy.
    - Render-test execution must be opt-in because extra instances can exhaust VRAM.
